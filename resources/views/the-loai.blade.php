...
<head>
    ...
    <title>{{$tentheloai->tentheloai}}</title>
</head>
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="" style="text-decoration: none">{{$tentheloai->tentheloai}}</a>
                </li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-md-8">
                <a href="" title="{{$tentheloai->tentheloai}}" class="nav-link">Truyện {{$tentheloai->tentheloai}} <i
